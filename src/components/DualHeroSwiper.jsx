...
// 图片数据
const leftSlides = [
    { src: "/images/SwiperBox/SwiperBox1.png", title: "Full-Body Low-Absorption Stair Tiles", desc: "Full-body low-absorption stair tiles are specifically designed for staircases and steps. Featuring a dense structure and anti-slip surface, these tiles offer low water absorption and high durability, ensuring safety and longevity in high-traffic environments. Perfect for residential, commercial, and public spaces, they combine functionality with sleek design." },
    { src: "/images/SwiperBox/SwiperBox2.png", title: "Low-Absorption Full-Body Wear-Resistant Tiles (SG Series)", desc: "Low-absorption full-body wear-resistant tiles are crafted with high-density materials that ensure minimal water absorption and outstanding durability. Featuring uniform color and a natural texture throughout the tile body, they are ideal for high-traffic areas such as shopping malls, corridors, kitchens, and outdoor spaces—perfect for those seeking both functionality and aesthetic appeal." },
    { src: "/images/SwiperBox/SwiperBox3.png", title: "Low-Absorption Full-Body Wear-Resistant Tiles (N Series)", desc: "The N Series low-absorption full-body wear-resistant tiles are crafted with advanced technology, offering uniform structure, exceptional abrasion resistance, and minimal water absorption. Ideal for high-traffic areas such as malls, stations, schools, and hospitals, they also provide aesthetic versatility for modern architectural design." },
    { src: "/images/SwiperBox/SwiperBox4.png", title: "Low-Absorption Full-Body Wear-Resistant Tiles (SG Series)", desc: "This SG Series highlights the authentic recreation of natural textures, with soft yet powerful linear surfaces reminiscent of weathered stone. The organic gradient and fine-grain finish make it ideal for both expansive applications and mixed-material designs, offering a calm and sophisticated spatial experience." },
    { src: "/images/SwiperBox/SwiperBox5.png", title: "Low-Absorption Full-Body Wear-Resistant Tiles (SG Series)", desc: "This SG Series centers on geometric textures with bold contrasts between depth and roughness. The tile surface offers a multi-dimensional feel, making it a perfect choice for creative commercial settings. It enhances both walls and floors with dramatic and expressive character." },  
];

const rightSlides = [
  { src: "/images/banner37.png", title: "Left Two", desc: "Description for left two." },
];
